<aside class="w-64 bg-white border-r border-gray-100 hidden lg:flex flex-col py-6 fixed h-full z-20">
    ...
    <nav class="flex-1 px-4 flex flex-col justify-start gap-2">
        ...
        <a href="#" 
           class="flex items-center w-full px-4 py-3 rounded-xl transition-all {{ request()->routeIs('layanan.*') ? 'text-blue-600 font-medium bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
