<x-app-layout>
    <div class="p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div
                class="bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 transition hover:shadow-md group relative overflow-hidden">
            ...
            <div class="bg-white p-6 rounded-[24px] shadow-sm border border-gray-100 transition hover:shadow-md group">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-3 bg-amber-50 rounded-2xl">
                        <svg class="w-6 h-6 text-amber-500 animate-spin-slow" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <tr>
                                <td colspan="4" class="py-20 text-center">
                                    <div class="flex flex-col items-center opacity-20">
                                        ...
                                        <p class="text-xl font-black italic uppercase tracking-widest">Antrean
                                            Kosong
                                        </p>
                                    </div>
                                </td>
