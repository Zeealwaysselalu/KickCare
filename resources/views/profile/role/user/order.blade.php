                            ...
                            <tr class="hover:bg-blue-50/20 transition-all group">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    @if ($progStatus === 'waiting')
                                        <span
                                            class="inline-flex items-center gap-1.5 bg-amber-50 text-amber-600 text-[10px] px-3 py-1 rounded-full font-bold uppercase border border-amber-100">
                                            <span class="w-1.5 h-1.5 bg-amber-500 rounded-full animate-pulse"></span>
                                            Menunggu
                                        </span>
                                    @elseif ($progStatus === 'cleared')
                                        <span
                                            class="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-600 text-[10px] px-3 py-1 rounded-full font-bold uppercase border border-emerald-100">
