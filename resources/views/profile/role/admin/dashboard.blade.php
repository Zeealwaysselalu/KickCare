                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-end justify-between">
                            <div>
                                <span
                                    class="font-roboto font-black text-5xl text-red-500 leading-none tracking-tighter">
                                    {{ $totalComplaints ?? 0 }}
                                </span>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-end justify-between">
                            ...
                            <div
                                class="p-4 bg-emerald-50 rounded-2xl text-emerald-500 shadow-sm border border-emerald-100">
                                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
