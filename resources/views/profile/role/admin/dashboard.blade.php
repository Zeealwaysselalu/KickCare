    ...
    <div class="p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                ...
                <p class="font-roboto text-gray-500 text-sm mt-1">Pantau performa bisnis dan operasional KickCare hari
                    ini.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <div
                class="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 transition hover:shadow-md group relative overflow-hidden">
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-end justify-between">
                        ...
                        <div
                            class="p-4 bg-red-50 rounded-2xl transition-all text-red-500 shadow-sm border border-red-100">
            ...
            <div
                class="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 transition hover:shadow-md group relative overflow-hidden">
                <div class="relative z-10">
                    <h2 class="font-montserrat font-bold text-[11px] text-gray-400 uppercase tracking-[2px] mb-6">Siap
                        Ambil</h2>
                    <div class="flex items-end justify-between">
                        <div>
                            <span
                                class="font-roboto font-black text-5xl text-emerald-500 leading-none tracking-tighter">
                                {{ $readyOrdersCount ?? 0 }}
                            </span>
        ...
        <div class="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden">
            <div
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 border border-blue-100">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @forelse ($allTransactions as $t)
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-8 py-6 text-center">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border {{ $statusColors[$prog] ?? 'bg-gray-50 text-gray-600' }}">
                                        {{ $prog }}
                                    </span>
                                </td>
                                <td class="px-8 py-6 text-center">
                                    {{-- FIX: Menggunakan variabel $paymentStatus yang merujuk ke kolom 'status' --}}
                                    @if ($paymentStatus === 'completed')
                                        <span
                                            class="text-[10px] font-bold text-emerald-600 uppercase italic bg-emerald-50 px-2 py-1 rounded border border-emerald-100">Lunas</span>
                                    @elseif($paymentStatus === 'cancelled')
                                        <span
                                            class="text-[10px] font-bold text-gray-400 uppercase italic bg-gray-50 px-2 py-1 rounded border border-gray-200">Dibatalkan</span>
                                    @else
                                        <span
                                            class="text-[10px] font-bold text-red-500 uppercase italic bg-red-50 px-2 py-1 rounded border border-red-100">Belum
                                            Bayar</span>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="py-20 text-center text-gray-400 italic">Antrian Workshop
                                    Kosong</td>
                            </tr>
                        @endforelse
                    </tbody>
