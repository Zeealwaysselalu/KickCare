                    ...
                    <div class="before-after">
                        ...
                        <div class="ba-side dirty">
                            <svg class="shoe-svg" viewBox="0 0 120 70" fill="none">
                                <ellipse cx="60" cy="52" rx="52" ry="12" fill="#8B5E3C"
                                    opacity=".4" />
                                <path d="M10 50 Q20 30 50 28 Q80 26 100 38 Q110 44 108 52 Q90 58 60 60 Q30 60 10 50Z"
                                    fill="#7B4A22" />
                                <path d="M50 28 Q55 15 70 14 Q85 13 95 22 Q100 28 100 38" fill="#6B3A18" />
                                <path d="M55 28 L58 16 M65 27 L66 14 M75 28 L78 17" stroke="#5A2E10" stroke-width="1.5"
                                    opacity=".6" />
                                <path d="M10 50 Q30 44 60 44 Q90 44 108 50" stroke="#5A2E10" stroke-width="1"
                                    opacity=".5" />
                            </svg>
                        </div>
                        <!-- Clean side -->
                        <div class="ba-side clean">
                            <svg class="shoe-svg" viewBox="0 0 120 70" fill="none">
                                <ellipse cx="60" cy="52" rx="52" ry="12" fill="#B0C8E8"
                                    opacity=".35" />
                                <path d="M10 50 Q20 30 50 28 Q80 26 100 38 Q110 44 108 52 Q90 58 60 60 Q30 60 10 50Z"
                                    fill="#E8EFF8" />
                                <path d="M50 28 Q55 15 70 14 Q85 13 95 22 Q100 28 100 38" fill="#D0DCF0" />
                                <path d="M55 28 L58 16 M65 27 L66 14 M75 28 L78 17" stroke="#A0B8D8" stroke-width="1.5"
                                    opacity=".7" />
                                <path d="M10 50 Q30 44 60 44 Q90 44 108 50" stroke="#A0B8D8" stroke-width="1"
                                    opacity=".5" />
                ...
                <div class="layanan-card">
                    <div class="layanan-icon-box">
                        <svg viewBox="0 0 24 24">
                            ...
                            <path d="M2 13.5A10.5 10.5 0 0 0 12 21a10.5 10.5 0 0 0 10-7.5" />
        ...
        <div class="container">
            ...
            <div class="about-inner">
                <div class="about-text-col">
                    <p>Didirikan pada awal tahun 2026, KickCare lahir dari sebuah keyakinan sederhana: sepatu bukan
                        sekadar alas kaki, melainkan fondasi dari kepercayaan diri Anda. Di era modern ini, kami
                        memahami bahwa mobilitas yang tinggi menuntut penampilan yang prima, namun waktu seringkali
                        menjadi kendala.</p>
                    <p>KickCare hadir sebagai solusi perawatan sepatu premium (Premium Shoe Treatment) yang
                        menggabungkan teknik pembersihan mendetail dengan teknologi perawatan modern. Kami tidak hanya
                        "mencuci", kami merawat. Mulai dari sneakers kesayangan, sepatu formal kulit, hingga boots, tim
                        ahli kami memahami karakteristik setiap material untuk mencegah kerusakan dan mengembalikan
                        pesona sepatu Anda seperti baru.</p>
                </div>
                <div class="logo-card">
