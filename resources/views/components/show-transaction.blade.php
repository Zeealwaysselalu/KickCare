    ...
    <div class="relative z-10">
        ...
        <div class="space-y-3 mb-6 bg-white p-2">
            <div class="flex justify-between text-[12px]">
                <span class="font-roboto text-gray-400">No. Referensi</span>
                <span class="text-gray-800 font-bold font-mono">{{ $transaction->transaction_code }}</span>
            </div>
            <div class="flex justify-between text-[12px]">
                <span class="font-roboto text-gray-400">Tanggal Transaksi</span>
                <span class="text-gray-800 font-bold font-mono">{{ $transaction->created_at->format('d M Y') }}</span>
            </div>
            <div class="flex justify-between text-[12px]">
                <span class="font-roboto text-gray-400">Outlet</span>
                <span class="text-gray-800 font-bold font-mono">{{ $transaction->outlet->name }}</span>
            </div>
            <div class="flex justify-between text-[12px]">
